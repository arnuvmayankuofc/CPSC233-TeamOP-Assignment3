...
/**
 * Handles when an attempt is made to add a Poll to a full PollList.
 * {@code PollListFullException} is a subclass of {@code Exception}
 * 
...
public class PollListFullException extends Exception {
	 ...
	 * @since 1.7
	 */
	protected PollListFullException(String message, Throwable cause, boolean enableSuppression,
