...
public class PartyTest {
	...
	{
		Party p = new Party("Another party");
		try {
			p.setProjectedNumberOfSeats(150.0f);
		} catch (InvalidPartyDataException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		try {
			p.setProjectedPercentageOfVotes(1.0001f);
		} catch (InvalidPartyDataException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	{
		Party p =new Party("A long party name");
		try {
			p.setProjectedNumberOfSeats(231.0f);
		} catch (InvalidPartyDataException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		try {
			p.setProjectedPercentageOfVotes(-.25f);
		} catch (InvalidPartyDataException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	{
		Party p =  new Party("This is a political party");
		try {
			p.setProjectedNumberOfSeats(-.025f);
		} catch (InvalidPartyDataException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	{
		Party p = new Party("Name of Party");
		try {
	...
	{
		Party p=new Party("Visualization Test");
		try {
